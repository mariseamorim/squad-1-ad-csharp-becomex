...
namespace CentralDeErrosApi.Controllers
{
    ...
    public class ErrorsController : Controller
    {
        ...
        private readonly IAmbiente _ambienteService;
        private readonly ILevel _levelService;
        private readonly IMapper _mapper;

        public ErrorsController(IError service, IAmbiente ambienteService, ILevel levelService, IMapper mapper)
        {
            _service = service;
        ...
        public ActionResult<Error> PostError([FromBody] ErrorDTO value)
        {
            ...
            if (!_ambienteService.AmbienteExists(value.EnvironmentId))
